...
import { ArrowRight, Truck, ShieldCheck, Zap, Star, ChevronLeft, ChevronRight, ShoppingBag } from 'lucide-react';
...
const heroImages = [
  {
    src: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?q=80&w=1080&auto=format&fit=crop",
    alt: "Modern Blue Armchair",
    title: "Modern Comfort",
    price: "$299"
  },
  {
    src: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1080&auto=format&fit=crop",
  ...
  return (
    <div className="space-y-24 pb-24">
      ...
      <section className="relative bg-[#FFF8F0] pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden">
        {/* Background Elements */}
        <div className="absolute top-0 right-0 w-1/3 h-full bg-orange-50/50 skew-x-12 transform origin-top-right -z-0"></div>
        <div className="absolute bottom-20 left-10 w-64 h-64 bg-orange-200/20 rounded-full blur-3xl -z-0"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-stone-900 leading-[1.1] mb-6 tracking-tight">
                Design Your <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-600">Dream Space</span>
              </h1>
              
              <p className="text-lg md:text-xl text-stone-600 mb-8 font-light max-w-lg leading-relaxed">
                Experience the perfect blend of aesthetic appeal and functional design. Elevate your home with our premium furniture collection.
              </p>
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-white rounded-full shadow-2xl z-0"></div>
              <motion.div 
                animate={{ rotate: 360 }}
              ...
              <div className="relative w-full max-w-md aspect-square z-10">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    >
                      <p className="text-xs text-stone-500 font-semibold uppercase tracking-wider mb-1">{heroImages[currentSlide].title}</p>
                      <div className="flex items-center justify-between gap-3">
                        <span className="text-xl font-bold text-stone-900">{heroImages[currentSlide].price}</span>
                        <button className="w-8 h-8 rounded-full bg-stone-900 text-white flex items-center justify-center hover:bg-orange-500 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.slice(0, 3).map((cat, idx) => (
            <Link to="/shop" key={cat.id} className="block h-full">
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-stone-100">
          <div className="grid grid-cols-2 gap-4">
            <img src="https://images.unsplash.com/photo-1758523907019-9ee0ce38f822?auto=format&fit=crop&q=80&w=600" alt="About 1" className="rounded-2xl w-full h-64 object-cover hover:shadow-lg transition-all" />
            <img src="https://images.unsplash.com/photo-1765282745950-99c5abe761f8?auto=format&fit=crop&q=80&w=600" alt="About 2" className="rounded-2xl w-full h-64 object-cover mt-8 hover:shadow-lg transition-all" />
          </div>
          <div>
            <span className="text-orange-500 font-bold tracking-wide uppercase text-sm mb-2 block">Our Story</span>
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6 leading-tight">We Create <span className="text-orange-500">Stylish</span> & Modern Furniture</h2>
            <p className="text-stone-600 mb-6 leading-relaxed text-lg">
              We create stylish and modern furniture that is both functional and beautiful. Discover our unique collections and transform your home into a haven of comfort and elegance.
            </p>
            <div className="flex gap-4">
              <Link to="/about" className="inline-block px-8 py-3 bg-stone-900 text-white rounded-full font-medium hover:bg-stone-800 transition-colors shadow-lg">
                Read More
              </Link>
            </div>
          </div>
      ...
      {/* Shop by Categories (Improved Design) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-10">
           <SectionHeading title="Shop by Categories" />
           <Link to="/shop" className="text-orange-500 font-medium hover:underline mb-12 flex items-center gap-1 group">
             View All <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
           </Link>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {categories.map((cat, idx) => (
             <Link to={`/shop?category=${cat.name}`} key={idx} className="group relative block">
                <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-stone-100 mb-4 shadow-sm group-hover:shadow-xl transition-all duration-500">
                   ...
                   {/* Overlay on hover */}
                   <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 z-20 transition-opacity duration-300"></div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
           <div className="bg-[#FFF8F0] rounded-3xl p-8 h-96 flex items-center justify-center relative overflow-hidden group">
               <div className="absolute top-0 right-0 w-64 h-64 bg-orange-200 rounded-full blur-3xl -mr-32 -mt-32 opacity-40 group-hover:opacity-60 transition-opacity duration-700"></div>
               <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-200 rounded-full blur-3xl -ml-32 -mb-32 opacity-40 group-hover:opacity-60 transition-opacity duration-700"></div>
               <img src="https://images.unsplash.com/photo-1603192399946-8bbb0703cfc4?auto=format&fit=crop&q=80&w=800" alt="Why Choose Us" className="max-h-full max-w-full object-contain mix-blend-multiply relative z-10 drop-shadow-lg group-hover:scale-105 transition-transform duration-500" />
           </div>
           <div>
         ...
         <div className="bg-stone-100 rounded-3xl p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
               ...
               <form className="flex flex-col sm:flex-row gap-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  />
                  <button type="submit" className="px-8 py-3 bg-orange-500 text-white font-semibold rounded-full shadow-lg hover:bg-orange-600 transition-colors">
                     Subscribe Now
                  </button>
               </form>
            </div>
            <div className="flex justify-center">
               <div className="bg-orange-100 p-8 rounded-full h-64 w-64 flex items-center justify-center">
                   <img src="https://images.unsplash.com/photo-1742714684748-5a5a8a21115a?auto=format&fit=crop&q=80&w=400" alt="Newsletter" className="w-40 h-auto object-contain mix-blend-multiply" />
               </div>
            </div>
         </div>
      </section>
